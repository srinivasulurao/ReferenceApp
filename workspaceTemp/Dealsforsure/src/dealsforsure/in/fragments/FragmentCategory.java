...
import dealsforsure.in.adapters.AdapterCategory;
...
public class FragmentCategory extends Fragment implements OnClickListener {
	...
	public void getDataFromServer(){
        ...
        try {
            ...
            json = userFunction.categoryList(tokenKey,deviceId,userLat,userLong);
            if(json != null){
		        ...
		        mCount          = new String[intLengthData];        
		        ...
		        for (int i = 0; i < intLengthData; i++) {
		            ...
		            mCount[i]       =dealObject.getString(userFunction.key_deal_count);
		            ...
		            map.put(userFunction.key_deal_count, mCount[i]);
