...
package com.vinscan.common.executor;

import com.vinscan.common.PlatformSupportManager;
...
public final class AsyncTaskExecManager extends PlatformSupportManager<AsyncTaskExecInterface> {
  ...
  public AsyncTaskExecManager() {
    ...
    addImplementationClass(11, "com.vinscan.common.executor.HoneycombAsyncTaskExecInterface");
  }
