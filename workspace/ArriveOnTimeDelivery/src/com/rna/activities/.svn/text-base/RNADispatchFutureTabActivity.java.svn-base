...
import com.rna.activities.RNADispatchFutureTabActivity.BatchIdAdapter;
import com.rna.activities.RNADispatchFutureTabActivity.BatchIdHandler;
import com.rna.activities.RNADispatchPastTabActivity.getSyncHandler;
...
public class RNADispatchFutureTabActivity extends Activity {
/** Called when the activity is first created. */
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		aotd_btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				 ...
				 Intent rna_present  = new Intent(RNADispatchFutureTabActivity.this,MainDispatchScreenTabView.class);
	...
	private void getBatchIdParserData() {
		...
		if(Utils.checkNetwork(getApplicationContext()))
		{
			...
			progressdialog = ProgressDialog.show(RNADispatchFutureTabActivity.this, "", "please wait..."); 
	...
	private void getOnlineData(){
		...
		String url = Utils.RNA_DISPATCH_FUTURE_URL;
	...
	private void getOfflineData(){
		...
		arr_batchId = _RNADataBase.getOfflineRNAOrders(mydate, "furture");
...
//	Called when the sync id done
	...
	public void showAlertDialog(String title, String msg) {
		...
		new AlertDialogMsg(RNADispatchFutureTabActivity.this, title, msg ).setPositiveButton("ok", new android.content.DialogInterface.OnClickListener(){
			 ...
			 batchId.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						if(batchId_status.getText().toString().equalsIgnoreCase("open")){
							Intent rna_pickup = new Intent(RNADispatchFutureTabActivity.this,RNAPickUpActivity.class);	
							...
							Intent rna_pickup = new Intent(RNADispatchFutureTabActivity.this,RNADeliveryActivity.class);	
							rna_pickup.putExtra("rna_data", data.get(position).getBatchDetails());	
							rna_pickup.putExtra("rna_batchId", data.get(position).getBatchId());
							startActivity(rna_pickup);	
						}
