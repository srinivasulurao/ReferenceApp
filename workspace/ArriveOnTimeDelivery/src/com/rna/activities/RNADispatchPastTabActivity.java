...
public class RNADispatchPastTabActivity extends Activity {
/** Called when the activity is first created. */
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		aotd_btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent rna_past  = new Intent(RNADispatchPastTabActivity.this,MainDispatchScreenTabView.class);
				rna_past.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				rna_past.putExtra("from", "rna");
				startActivity(rna_past);		
	...
	private void getBatchIdParserData() {
		...
		if(Utils.checkNetwork(getApplicationContext()))
		{
			...
			progressdialog = ProgressDialog.show(RNADispatchPastTabActivity.this, "", "please wait..."); 
	...
	private void getOnlineData(){
		...
		String url = Utils.RNA_DISPATCH_PAST_URL;
	...
	private void getOfflineData(){
		...
		arr_batchId = _RNADataBase.getOfflineRNAOrders(mydate, "past");
...
//	Called when the sync id done
	...
	public void showAlertDialog(String title, String msg) {
		...
		new AlertDialogMsg(RNADispatchPastTabActivity.this, title, msg ).setPositiveButton("ok", new android.content.DialogInterface.OnClickListener(){
			 ...
			 batchId.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						if(batchId_status.getText().toString().equalsIgnoreCase("open")){
							Intent rna_pickup = new Intent(RNADispatchPastTabActivity.this,RNAPickUpActivity.class);	
							...
							Intent rna_pickup = new Intent(RNADispatchPastTabActivity.this,RNADeliveryActivity.class);	
							rna_pickup.putExtra("rna_data", data.get(position).getBatchDetails());	
							rna_pickup.putExtra("rna_batchId", data.get(position).getBatchId());
							startActivity(rna_pickup);	
						}
