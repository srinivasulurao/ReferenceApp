...
public class DispatchOpenFutureParser extends HttpLoader{
	...
	//private ArrayList <CarsListModel> carsListFeeds = null;
		...
		public DispatchOpenFutureParser(Handler handler,String feedUrl , ArrayList<DispatchAllListModel> _arrDispatchList) 
		{
			super(feedUrl);
