...
public class DispatchOpenPresentParser extends HttpLoader {
	...
	public DispatchOpenPresentParser(Handler handler,String feedUrl , ArrayList<DispatchAllListModel> _arrDispatchList) 
	{
		super(feedUrl);
