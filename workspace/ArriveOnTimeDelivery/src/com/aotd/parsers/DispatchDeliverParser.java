...
public class DispatchDeliverParser extends HttpLoader {
	...
	public DispatchDeliverParser(Handler handler,String feedUrl , ArrayList<DispatchAllListModel> _arrDispatchList) 
	{
		super(feedUrl);
	                    	...
	                    	{	
		                        if (name.equalsIgnoreCase("dispatches-info")){	                        	
		                            ...
		                            }else if (name.equalsIgnoreCase("orderStatus"))
		                            {
		                            	...
		                            	if(s1.equals("Delivered"))
		                            	{
		                            		sStatus = "Delivered";
		                            	}
		                            	
		                            	if(s1.equals("Open Order"))
		                            	{
		                            		sStatus = "Open Order";
		                            	}
