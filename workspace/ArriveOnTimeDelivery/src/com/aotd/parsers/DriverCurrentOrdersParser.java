...
public class DriverCurrentOrdersParser extends HttpLoader {
	
	//private ArrayList <CarsListModel> carsListFeeds = null;
	private Handler parentHandler;
	ArrayList<DispatchAllListModel> marrDispatchList;
	
	private String DLOrderTime;
	private boolean isRoundTrip;
	
	public DriverCurrentOrdersParser(Handler handler,String feedUrl , ArrayList<DispatchAllListModel> _arrDispatchList) 
	{
		super(feedUrl);
	                ...
	                switch (eventType)
	                {
	                    	...
	                    	{	
		                        if (name.equalsIgnoreCase("dispatches-info")){	                        	
		                        	...
		                        	if (name.equalsIgnoreCase("order_id")){	 
		                            	...
		                            	DLOrderTime = parser.nextText();
		                        		mDispatchPresentListModel.setDLDate(DLOrderTime);
	                    ...
	                    case XmlPullParser.END_TAG:
	                        ...
	                        if (name.equalsIgnoreCase("order") && orderInfoFound == true){
	                        	...
	                        	if(DLOrderTime.equalsIgnoreCase("0000-00-00 00:00:00"))
