...
public class DispatchAllParser extends HttpLoader {
	...
	public DispatchAllParser(Handler handler,String feedUrl , ArrayList<DispatchAllListModel> _arrDispatchList) 
	{
		super(feedUrl);
	                    	...
	                    	{	
		                        if (name.equalsIgnoreCase("dispatches-info")){	                        	
		                            ...
		                            }else if (name.equalsIgnoreCase("orderStatus"))
		                            {
		                            	...
		                            	mDispatchPresentListModel.setPuCellPhone(parser.nextText().toString());
		                            }
		                            else if (name.equalsIgnoreCase("homePhone")){
		                            	mDispatchPresentListModel.setPuHomephone(parser.nextText().toString());
		                            }
		                            else if (name.equalsIgnoreCase("dl_cellPhone")){
		                            	mDispatchPresentListModel.setDlCellPhone(parser.nextText().toString());
		                            }
		                            else if (name.equalsIgnoreCase("dl_homePhone")){
		                            	mDispatchPresentListModel.setDlHomePhone(parser.nextText().toString());
		                            }
		                            else if (name.equalsIgnoreCase("Piece")){
		                            	mDispatchPresentListModel.setPeice(parser.nextText().toString());
		                            }
		                            else if (name.equalsIgnoreCase("Weight")){
		                            	mDispatchPresentListModel.setWeight(parser.nextText().toString());
		                            }
		                            else if (name.equalsIgnoreCase("notes")){
		                            	mDispatchPresentListModel.setAccountnotes(parser.nextText().toString());
		                            }
		                            else if (name.equalsIgnoreCase("adminNotes")){
		                            	mDispatchPresentListModel.setAdminnotes(parser.nextText().toString());
		                            }
		                            else if (name.equalsIgnoreCase("ref")){
		                            	mDispatchPresentListModel.setRef(parser.nextText().toString());
		                            }
		                            else if (name.equalsIgnoreCase("requestor")){
		                            	mDispatchPresentListModel.setRequestor(parser.nextText().toString());
		                            }
		                            else if (name.equalsIgnoreCase("PUInstruction")){
		                            	mDispatchPresentListModel.setPuinstruction(parser.nextText().toString());
		                            }
		                            else if (name.equalsIgnoreCase("DLInstruction")){
		                            	mDispatchPresentListModel.setDlinstruction(parser.nextText().toString());
		                            }
