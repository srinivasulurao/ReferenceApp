...
public class SearchAdapter extends BaseAdapter{
	...
	public List<SearchModel> listData;
	...
	public SearchAdapter(Activity contex_a,List<SearchModel> listData){
		...
		if(connectionsItem.getIs_friend().equalsIgnoreCase("true")){
			...
			holder.connectImage.setOnClickListener(new OnClickListener(){
				...
				public void onClick(View v) {
					...
					mConnectAlert = getCheckConnectAlert("Do you want to disconnect friend?");
					mConnectAlert.show();
				}
		...
		// got a friend request 
        	...
        	holder.connectImage.setOnClickListener(new OnClickListener(){
				...
				public void onClick(View v) {
					...
					mConnectAlert = getCheckConnectAlert("Friend Request");
		        	mConnectAlert.show();
		        	}
        		});
        	  }
		// cancel a pending friend request
			...
			holder.connectImage.setOnClickListener(new OnClickListener(){
				...
				public void onClick(View v) {
					...
					mConnectAlert = getCheckConnectAlert("Cancel the Friend Request?");
					mConnectAlert.show();
					}
				});
          ...
          holder.connectImage.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
			 ...
			 mConnectAlert = getCheckConnectAlert("Do you want to connect?");
		     mConnectAlert.show();	
			}
        	  });
          }
