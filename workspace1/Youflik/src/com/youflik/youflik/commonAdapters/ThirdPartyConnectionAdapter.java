...
import com.youflik.youflik.commonAdapters.ConnectionAdapter.ViewHolder;
import com.youflik.youflik.models.FriendsModel;
import com.youflik.youflik.utils.Util;

public class ThirdPartyConnectionAdapter extends BaseAdapter{
	...
	public ThirdPartyConnectionAdapter(Context context,ArrayList<FriendsModel> listData){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			convertView = layoutInflater.inflate(R.layout.custom_thirdparty_user_friends, null);
			holder = new ViewHolder();
			holder.textViewName = (TextView) convertView.findViewById(R.id.thirdPartyfriendsname);
			holder.imageViewPhoto = (ImageView) convertView.findViewById(R.id.thirdPartyfriendsImage);
