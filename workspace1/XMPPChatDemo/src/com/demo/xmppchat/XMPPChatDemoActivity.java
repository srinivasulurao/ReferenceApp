...
public class XMPPChatDemoActivity extends Activity {
	...
	public static final String HOST = "104.131.37.146";
	public static final int PORT = 5222;
	public static final String SERVICE = "cheappy.co";
	//public static final String USERNAME = "brick-test";
			...
			public void run() {
				...
				try {
						 ...
						 if (connection.isAuthenticated()) {
				              ...
				              try {  
				                manager.createAccount("hello","123");
